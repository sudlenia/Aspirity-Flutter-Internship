...
mixin _$LeaguesResponse {
  ...
  List<LeagueDto> get data => throw _privateConstructorUsedError;
...
abstract class $LeaguesResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool status, List<LeagueDto> data});
}
...
class _$LeaguesResponseImpl implements _LeaguesResponse {
  const _$LeaguesResponseImpl(
      {required this.status, required final List<LeagueDto> data})
      : _data = data;
  ...
  @override
  final bool status;
  final List<LeagueDto> _data;
  @override
  List<LeagueDto> get data {
  ...
  @override
  String toString() {
    return 'LeaguesResponse(status: $status, data: $data)';
  }
...
abstract class _LeaguesResponse implements LeaguesResponse {
  const factory _LeaguesResponse(
      ...
      required final List<LeagueDto> data}) = _$LeaguesResponseImpl;
